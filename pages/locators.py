...
"""Общие локаторы для модулей краткого и подробного расчёта"""
...
class LocatorsBriefCalculate():
	...
	FIELD_DESIRED_IOAN_LOC = (By.CSS_SELECTOR, "input[name='field-desired-loan']")
	FIELD_INITIAL_PAYMENT_LOC = (By.CSS_SELECTOR, "input[name='field-initial-payment']")
	FIELD_CREDIT_TERM_LOC = (By.CSS_SELECTOR, "input[name='field-credit-term']")
